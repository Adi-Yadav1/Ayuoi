...
const MOCK_MESSAGES: ChatMessage[] = [
	{
		...
		role: "assistant",
		text:
			"Hello. I can help with personalized diet suggestions, meal timing, and routines. Ask me anything.",
		time: "09:12",
	},
	{
		id: "m2",
	...
	},
	{
		...
		role: "assistant",
		text:
			"Try a warm vegetable bowl with cumin, ginger, and a small portion of grains. Avoid heavy fried foods.",
		time: "09:15",
	},
];
		...
		<SafeAreaView style={styles.safeArea}>
			...
			<Animated.View style={[styles.heroCard, { opacity: fadeAnim }]}>
				...
				<Text style={styles.heroBody}>
					Keep meals warm, lightly spiced, and easy to digest. Prioritize
					cooked vegetables and moderate grains.
				</Text>
